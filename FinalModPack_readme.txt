...
CHANGELOG:
2.8f: Less MiB missions. Grav module can be recovered from Waspites. Better Dart Rifle graphics (by Brain_322). Fixed Waspite research (thanks R1dO). Fixed Junkfarm terrain movement costs. Fixed Jump Armor sprite (thanks The Martian). Fixed position of HC and AC AA clips (by Brain_322). URBITS tile 22 is destructible.
