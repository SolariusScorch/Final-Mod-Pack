...
CHANGELOG:
2.8h: 4 new Jungle maps (collab with Dioxine). 1 new Postindustrial map (by Dioxine). Battleship walls are less transparent. Improved graphics for some ranked aliens (by The Martian).
