...
CHANGELOG:
4.2: 2 new Rice Farm maps and enabled huge maps in the script. New Urban map (by Dioxine). Improved Slovak name list (thx Meridian). Fixed floating rocks on Sandy Rocks Alternative. Minor fixes.
