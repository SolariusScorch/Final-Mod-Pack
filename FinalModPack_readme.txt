...
CHANGELOG:
3.0: New Junkfarm/Native Urban maps (by Dioxine). Renamed Plasma Blaster to Plasma Destroyer for clarity. Better lift animation (by Brain_322). Better jungle trees (by Dioxine). Fixed outdated Postindustrial tilesets. Minor fixes.
