...
CHANGELOG:
3.1: Synthsuit yields better bonuses. Alien Drones fly freely.  Added Gravmodule stat bonuses. Hazmat is somewhat stronger. Plasma blades deal plasma damage. Fancier photonic blade effects. New MiB Commander sprites (by Brain_322). New Salamandron sprites (by Drages). New Juggernaut sprites (by Wolverin). Alien Drone weapon looks less like a laser. Added some new inventory pictures. Various armor tweaks and improvements. Soldier names code streamlined. Fixed Toxi-Suit palette.
