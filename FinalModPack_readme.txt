...
CHANGELOG:
3.8: 3 new Urban maps (by Dioxine). 1 new Rocks map (by Dioxine). 2 new Postindustrial maps (by Dioxine). 1 new Port map (by Dioxine) and enabled huge maps in the script. 7 new Commercial maps (3 by Dioxine, 4 by MeyMey) and enabled huge maps in the script. Unique sprite for Ethereal Commander (design by Christof the Improper). Fixed MILTECH tileset. Minor fixes.
