...
CHANGELOG:
: New Forest map. New Postindustrial map (by Dioxine). Fixed Sandy Plains Alternative walking sounds. Fixed Auto-Cannon aimed range. Fixed an issue with Muton Commander corpse recovery. Minor fixes.
