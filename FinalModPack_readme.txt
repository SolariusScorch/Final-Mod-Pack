...
CHANGELOG:
3.8: 1 new Urban map (by Dioxine). 1 new Rocks map (by Dioxine). 1 new Port map (by Dioxine) and enabled huge maps in the script. 3 new Commercial maps (by Dioxine) and enabled huge maps in the script. Minor fixes.
