...
CHANGELOG:
4.0: New Forest map. New Postindustrial map (by Dioxine). Fixed Sandy Plains Alternative walking sounds. Fixed Auto-Cannon aimed range. Fixed an issue with Muton Commander corpse recovery. Fixed some walls in Alien Base. Minor fixes.
