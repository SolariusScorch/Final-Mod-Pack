...
CHANGELOG:
3.8: 3 new Urban maps (by Dioxine). 1 new Rocks map (by Dioxine). 2 new Postindustrial maps (by Dioxine). 1 new Port map (by Dioxine) and enabled huge maps in the script. 3 new Commercial maps (by Dioxine) and enabled huge maps in the script. Minor fixes.
