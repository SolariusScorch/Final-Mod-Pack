...
CHANGELOG:
3.1: Synthsuit yields better bonuses. Alien Drones fly freely.  Added Gravmodule stat bonuses. Hazmat is somewhat stronger. New MiB Commander sprites (by Brain_322). New Salamandron sprites (by Drages). New Juggernaut sprites (by Wolverin). Alien Drone weapon looks less like a laser. Armor code streamlined. Soldier names code streamlined. Fixed Toxi-Suit palette.
