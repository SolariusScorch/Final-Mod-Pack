...
CHANGELOG:
2.8f: Less MiB missions. Grav module can be recovered from Waspites. Fixed Waspite research (thanks R1dO). Fixed Junkfarm terrain movement costs. Fixed Jump Armor sprite (thanks The Martian).
