...
CHANGELOG:
3.0: New Junkfarm/Native Urban maps (by Dioxine). New 30x30 maps for several terrains. New farm map (by Dioxine). Renamed Plasma Blaster to Plasma Destroyer for clarity. New Ufopedia picture for the Skymarshall (by Nord). Better lift animation (by Brain_322). Better jungle trees (by Dioxine). Fixed Avenger/Dropship cockpit (by Buscher). Fixed outdated Postindustrial tilesets. Minor fixes.
